              ...
              <container *ngIf="viewMosaicXpx">
                <div class="mt-3">
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <span class="fs-08rem fw-bolder">{{mosaicXpx.mosaicInfo.mosaicName}}</span>
                    </div>
                  </div>
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-md-9">
                      <span class="fs-08rem fw-bolder">{{mosaicXpx.amountFormatter}}</span>
                    </div>
                  </div>
                </div>
              </container>
