...
@NgModule({
  declarations: [CreateWalletComponent, ImportWalletComponent, WalletCreatedComponent, SelectionWalletCreationTypeComponent, WalletNis1FoundComponent, TransferXpxComponent, WalletNis1AccountsConsignerComponent],
  imports: [
    CoreModule,
    WalletRoutingModule
  ]
